...
class BookmarkViewer extends StatefulWidget {
  ...
  final List<Map<String, dynamic>> bookMarkUserIdList;
  final String uid;

  BookmarkViewer({Key key,@required this.uid, @required this.bookMarkUserIdList}) : super(key: key);

  @override
  BookmarkViewerState createState() => new BookmarkViewerState(uid: uid,bookMarkUserIdList: bookMarkUserIdList);
}

class BookmarkViewerState extends State<BookmarkViewer>{

  BookmarkViewerState({Key key,@required this.uid, @required this.bookMarkUserIdList});
      ...
      body: Container(
        child: ListView.builder(
          itemBuilder: (context, index) =>
              buildItem(context, bookMarkUserIdList[index]),
          itemCount: bookMarkUserIdList.length,
        ),
      ),
    );
  }
